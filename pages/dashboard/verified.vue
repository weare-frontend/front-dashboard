            ...
            <div class="col align-self-center">
                ...
                <form class="mt-3 animated fadeIn" v-show="step == 1">
                    <div class="row">
                        ...
                        <div class="col-12 mb-3 bg-white" style="filter: drop-shadow(2px 2px 3px black); line-height: 1.2em; border-radius: 20px;">
                            <h6 class="text-center text-dark mt-1">กฏกติกา การฝาก-ถอน</h6>
                            <hr style=" border:solid 1px #C4C4C4; " />
                            <small class="text-dark">1. ชื่อ-นามสกุล กรุณาใช้ข้อมูลของบัญชีธนาคารเท่านั้น มิเช่นนั้นท่านจะไม่สามารถถอนเงินออกได้</small>
                            <br />
                            <small class="text-dark">2.ต้องใช้เบอร์โทรศัพท์ของท่านเท่านั้นเพื่อยืนยันรหัส OTP</small>
                            <br />
                            <br />
                        </div>
                    </div>
                    <div style="overflow: hidden;">
                        <div class="row">
                            <div class="col-6">
                                <h6 class="text-template font-weight-100">เพศ</h6>
                                <div class="form-group m-0" style="font-weight: 100; white-space: nowrap;">
                                    <div class="custom-control custom-radio custom-control-inline" style="font-weight: 100; white-space: nowrap;">
                                        ...
                                        <label class="custom-control-label mr-2 small font-weight-100" for="selectSexMan">ชาย</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        ...
                                        <label class="custom-control-label small font-weight-100" for="selectSexWoman">หญิง</label>
                                    </div>
                                </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <h6 class="text-template font-weight-100">อายุ</h6>
                                    <select class="custom-select form-controls form-control-lg text-dark text-center" ref="selectAge" @change="removeValidation('selectAge')" :class="{'is-invalid' : formValidation('selectAge')}" required>
                            ...
                            <div class="col-12 mt-2">
                                <div class="form-group">
                                    <h6 class="text-template font-weight-100">คุณรู้จักเรา จากช่องทางใด</h6>
                                    <select class="custom-select form-controls form-control-lg text-dark text-center" ref="selectWay" @change="removeValidation('selectWay')" :class="{'is-invalid' : formValidation('selectWay')}" required>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <h6 class="text-template" style="font-weight:100;">ชื่อจริง</h6>
                                    <input type="text" ref="inputFirstName" :class="{'is-invalid' : formValidation('inputFirstName')}" @keyup="removeValidation('inputFirstName')" class="form-controls form-control-lg text-center" placeholder="ชื่อจริง" required />
                                    <div class="invalid-feedback">{{ formValidation('inputFirstName') }}</div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <h6 class="text-template" style="font-weight:100;">นามสกุล</h6>
                                    <input type="text" ref="inputLastName" :class="{'is-invalid' : formValidation('inputLastName')}" @keyup="removeValidation('inputLastName')" class="form-controls form-control-lg text-center" placeholder="นามสกุล" required />
                        ...
                        <div class="row mb-5">
                            <div class="col-12">
                                <div class="form-group">
                                    <h6 class="text-template" style="font-weight:100;">เลือกธนาคารของลูกค้า</h6>
                                    <select class="custom-select form-controls form-control-lg" ref="selecBankAccount" @change="removeValidation('selecBankAccount')" :class="{'is-invalid' : formValidation('selecBankAccount')}">
                                        <option value disabled selected class="text-dark" style="font-weight:100;">กรุณาเลือกธนาคารของลูกค้า</option>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <h6 class="text-template" style="font-weight:100;">เลขบัญชีธนาคาร</h6>
                                    <input type="number" pattern="\d*" maxlength="13" v-model="inputBankAccountNumber" ref="inputBankAccountNumber" :class="{'is-invalid' : formValidation('inputBankAccountNumber')}" @keyup="removeValidation('inputBankAccountNumber')" class="form-controls form-control-lg text-center" placeholder=" เลขบัญชีธนาคาร" required />
            ...
            if (!this.inputBankAccountNumber.match(/^[0-9]+$/)) {
                ...
                if (chkregister.success) {
                    ...
                    this.$toast.global.error({
                        message: chkregister.data[0].error
                    });
                    return (this.step = 1);
                }
                this.formError.push({
