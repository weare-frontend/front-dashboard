<template>
  <div class="container" style="margin-top:-80px;">
    ...
    <div class="row mb-5">
      <div class="item col-4 col-sm-4 col-md-3 col-lg-3" v-for="(list, i) in listgamecard.lists" :index="i" :key="i">
        <div
          class="btn25 aos-init aos-animate"
          data-aos="fade-up"
          data-aos-delay="200"
          data-aos-duration="400"
          @click="gameluca(list.name,list.gameId)"
        >
            <img class="w-100" :src="list.thumbnail" alt="game casino"/>
            <div class="buttons">
...
export default {
  ...
  asyncData: async function ({ $axios}) {
    const game = await $axios.$get("https://topup-sportbook88.askmebet.io/v0.1/partner/member/gameList/ambgame/c54583174899b9336642622799fa2bbb");
    return { listgamecard: game.data };
  },
  computed: {
