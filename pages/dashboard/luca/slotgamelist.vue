<template>
  <div class="container">
    ...
    <div id="exTab2" class="container mb-4 mb-5">
            <ul class="nav nav-tabs justify-content-center d-none">
                <li class="active">
                    <a data-toggle="tab" href="#home" class="px-4">เกมสล๊อต</a>
                </li>
                <li id="fishtab"><a data-toggle="tab" href="#menu1">เกมยิงปลา</a></li>
            ...
            <div class="tab-content">
                ...
                <div id="menu1" class="tab-pane fade">
                    <div class="row py-3 d-none" id="fish"></div>
                </div>
                <div id="menu2" class="tab-pane fade">
                    <div class="row py-3 d-none" id="arcade"></div>
                </div>
            </div>
        </div>
  </div>
...
export default {
  ...
  mounted: function () {
    ...
    //  return true;
        ...
        if (this.listGameArray[this.paramId].productCode == "askmebet") {
            var fish = 3;
            $("#arcadetab").css("display", "none");
            $("#menu2").css("display", "none");
        } else if (this.listGameArray[this.paramId].productCode == "gamatron") {
            var fish = 1;
            $("#arcadetab").css("display", "none");
            $("#menu2").css("display", "none");
        } else if (this.listGameArray[this.paramId].productCode == "slotxo") {
            var fish = 15;
            $("#arcadetab").css("display", "none");
            $("#menu2").css("display", "none");
        } else if (this.listGameArray[this.paramId].productCode == "spade_gaming") {
            var fish = 2;
            $("#arcadetab").css("display", "none");
            $("#menu2").css("display", "none");
        } else if (this.listGameArray[this.paramId].productCode == "live_22") {
            var fish = 2;
            var arcade = 1;
            $("#fishtab").css("display", "none");
            $("#menu1").css("display", "none");
            // $("#menu2").css("display", "block");
        } else if (this.listGameArray[this.paramId].productCode == "pg_slot") {
            var fish = 1;
            var arcade = 1;
            $("#fishtab").css("display", "none");
            $("#menu1").css("display", "none");
            $("#arcadetab").css("display", "none");
            $("#menu2").css("display", "none");
        } else if (this.listGameArray[this.paramId].productCode == "ameba") {
            var fish = 1;
            var arcade = 1;
            $("#fishtab").css("display", "none");
            $("#menu1").css("display", "none");
        ...
        if (
            this.listGameArray[this.paramId].productCode == "askmebet" ||
            this.listGameArray[this.paramId].productCode == "gamatron" ||
            this.listGameArray[this.paramId].productCode == "slotxo" ||
            this.listGameArray[this.paramId].productCode == "spade_gaming" ||
            this.listGameArray[this.paramId].productCode == "live_22"
        ) {
            var textHtml = "";
            var f = 0;
            for ( f < fish; f++;) {
                textHtml +=
                    '<div class="text-center col-4 col-sm-4 col-md-3 col-lg-2"><div class="btn25 media aos-init aos-animate" data-aos="fade-up" data-aos-delay="600" data-aos-duration="800" ><img class="w-100" src="assets/images/slot/' +
                    this.listGameArray.lists[f].productCode +
                    "/fishing/slot_fsh0" +
                    f +
                    '.png" /><a href="" class="text-center mt-2 text-white ovrly">เข้าสู่เกมส์ </a> <div class="buttons"><a href="" class="fa fa-sign-in"> </a></div></div></div>';
            }
            document.getElementById("fish").innerHTML = textHtml;
            ...
            for (a = 0; a < arcade; a++) {
                arcadeHtml +=
                    '<div class="text-center col-4 col-sm-4 col-md-3 col-lg-2"><div class="btn25 media aos-init aos-animate" data-aos="fade-up" data-aos-delay="600" data-aos-duration="800" ><img class="w-100" src="assets/images/slot/' +
                    this.listGameArray[this.paramId].lists[a].productCode +
                    "/arcade/slot_arc0" +
                    a +
                    '.png" /><a href="" class="text-center mt-2 text-white ovrly">เข้าสู่เกมส์ </a> <div class="buttons"><a href="" class="fa fa-sign-in"> </a></div></div></div>';
            }
            document.getElementById("arcade").innerHTML = arcadeHtml;
        }
       return true;
  },
  methods: {
...
<style scope>
.btn25 {
  /* background: linear-gradient( 0deg, #000, #9b712d 13%, #383838 40%, #1f1f1f 63%, #686868 95%, #f5c8b4 90%, #7c5019 ); */
  margin: 5% auto;
