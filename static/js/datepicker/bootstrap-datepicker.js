...
!function( $ ) {
	...
	var DPGlobal = {
		...
		headTemplate: '<thead>'+
							'<tr>'+
								'<th class="prev"><i class="icon-arrow-left"/><i class="material-icons">keyboard_arrow_left</i></th>'+
								'<th colspan="5" class="datepicker-switch"></th>'+
								'<th class="next"><i class="icon-arrow-right"/><i class="material-icons">keyboard_arrow_right</i></th>'+
							'</tr>'+
						'</thead>',
